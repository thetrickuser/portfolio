...
import {FaAngleDown, FaAngleUp, FaGithub, FaLinkedin, FaLocationDot, FaPhone} from "react-icons/fa6";
...
export const Sidebar = () => {
    ...
    return (
        <aside
            ...
            <div className={`flex flex-row gap-4 xl:flex-col items-center justify-center ${showContact ? "" : "mb-0"} xl:mb-8`}>
                <img
                    src={dp}
                    alt="Profile Picture"
                ...
                <div className={'flex justify-center'}>
                    <button
                        className={`xl:hidden inline-block mt-4 mb-2 px-4 py-2 bg-blue-600 text-white rounded-full shadow transition-colors duration-200
                          ${showContact ? "bg-blue-800" : ""}`}
                        onClick={() => setShowContact((v) => !v)}>
                        {showContact ? <FaAngleUp/> : <FaAngleDown/>}
                    </button>
                </div>
            </div>
            ...
            >
                <ul className="flex flex-row flex-wrap items-center md:justify-center gap-5 xl:flex-col xl:items-start xl:gap-3">
            ...
            {/* Social Links */}
            <div className={`flex justify-center space-x-6 mt-4 xl:mt-0 ${showContact ? "block" : "hidden"} xl:flex`}>
                <a
